...
/* harmony import */ var _modules_gerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/gerator */ "./src/js/modules/gerator.js");
...
window.onload = function () {
  ...
  Object(_modules_gerator__WEBPACK_IMPORTED_MODULE_2__["default"])();
};
...
var generator = function generator() {
  ...
  function generate(e) {
    ...
    var specials = '!@#$%^&*()_+?><:{}[]';
    var numsA = nums.split(""); //Array with numers

    var lettersA = letters.split(""); //Array with letters

    var specialsA = specials.split(""); //Array with special symbols

    if (checkN.checked === true) {
      console.log(1);
    }

    var finishArr = [].concat(_toConsumableArray(numsA), _toConsumableArray(lettersA), _toConsumableArray(specialsA));
    var passwordLenght = 16;
    var password = '';

    for (var i = 0; i < passwordLenght; i++) {
      var randomNumber = Math.floor(Math.random() * finishArr.length);
